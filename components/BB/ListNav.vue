    ...
    export default {
        ...
        /*1.第一次进入list后，收到id，这里做ajax请求*/
            ...
            next(vm=>{//vm是当前组件
                ...
                //组件还没出来，不能使用this
                vm.ajaxNav("http://localhost:3456/api/getArticleNav2?id="+to.params.id.split(/&/)[0].replace(/^idA=/,''));
        ...
        /*2.以及进入list组件，id有变化，就要重新请求ajax，重新渲染*/
            ...
            this.ajaxNav("http://localhost:3456/api/getArticleNav2?id="+to.params.id.split(/&/)[0].replace(/^idA=/,''));
        ...
        methods:{
            ajaxNav(url){  //console.log(url,'开始Nav请求');
                ...
                ajax.onreadystatechange=()=>{
                    if(ajax.readyState==4&&ajax.status==200){
                        ...
                        //this.ajaxMain("http://localhost:3456/api/getArticleMain2?id="+this.listPidData.toString());
            ...
            ajaxMain(id) {
              ...
              if(this.$refs.BB_ListMain){
                ...
                this.$refs.BB_ListMain.ajaxMain("http://localhost:3456/api/getArticleMain2?id="+id);  // 调用子组件的方法
              }
            }
