    ...
    export default {
        ...
        created(){
            ...
            var p1=new Promise((success,err)=>{/*轮播图的请求*/
                ...
                ajax1.open("get","http://localhost:3456/api/getBanners?num=5",true);
                ajax1.send();
            ...
            /*导航分类的请求*/
               var p2=new Promise((success,err)=>{
                   ...
                   ajax2.open("get","http://localhost:3456/api/getType",true);
                   ajax2.send();
         ...
         /*人气产品的请求*/
            var p3=new Promise((success,err)=>{
                  ...
                  ajax3.open("get","http://localhost:3456/api/getRenqiArticle");/*默认打开加载4个,数据库控制*/
                  ajax3.send();
            ...
            /*最新产品的请求*/
               var p4=new Promise((success,err)=>{
                     ...
                     ajax4.open("get","http://localhost:3456/api/getNewArticle?num="+this.list[1].listNum,true);/*默认打开加载4个*/
                     ajax4.send();
            ...
            /*精品的请求*/
               var p5=new Promise((success,err)=>{
                     ...
                     ajax5.open("get","http://localhost:3456/api/getJingArticle",true);/*默认打开加载8个*/
                     ajax5.send();
       ...
       /*对所有的ajax请求，进行数据监控,Promise.all异步对象，监控所有的，是对的就全部得到，错了一个就得到错的*/
        ...
        data(){
            return {
                /*实际开发中，这里写ajax请求到的数据*/
                bannerData: null,/*获取 banner图类型的文章:http://localhost:3456/api/getBanners?num=3*/
                listnavs:[],
              /*获取 最新的文章 http://localhost:3456/api/getNewArticle?num=3*/
                list:[
                    {
                      nav:{title:"人气产品"},
                      list:null
